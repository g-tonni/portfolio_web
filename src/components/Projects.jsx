...
function Projects() {
  ...
  return (
    <>
      <div
        id="projects"
        className="w-full py-20 px-6 sm:px-25 md:py-20 md:px-15 lg:py-30 lg:px-30 xl:px-60 2xl:px-80 3xl:px-100 4xl:px-140 5xl:px-170"
      >
      ...
      <AnimatePresence>
        {openModal > 0 && (
          <motion.div
            ...
            animate="show"
            exit="hidden"
            className="fixed w-full h-screen top-0 left-0 bg-brand-dark/60 z-100 backdrop-blur-sm md:py-20 md:px-15 lg:px-30 xl:px-60 2xl:px-80 3xl:px-100 4xl:px-140 5xl:px-170"
          >
            <motion.div
              variants={modal}
              initial="hidden"
              animate="show"
              exit="exit"
              className="bg-brand-light md:rounded-3xl w-full h-full overflow-y-auto px-3 sm:px-6 md:px-15 py-5 md:py-10 border-5 border-y-5 md:border-y-20 border-transparent relative shadow-xl shadow-brand-dark/40"
            >
              <div
